...
class Pendulum(object):
    ...
    def pendulum_linear_dynamics(self, x, u, *_):  
        ...
        # a0 = - self.m * self.g * self.l / (self.I + self.m*self.l**2)
        # a1 = self.b / (self.I + self.m*self.l**2)
        # b0 = self.m * self.l / (self.I + self.m*self.l**2)
        ...
        # Ac = [[0, 1, 0, 0], 
        #       [0, -self.bc * v2, self.m ** 2 * self.l ** 2 * self.g * v2 / (self.I + self.m * self.l ** 2), -self.m * self.l * self.bp * self.v2 / (self.I + self.m * self.l ** 2)],
        #       [0, 0, 0, 1],
        #       [0, -self.m * self.l * self.bc * self.v1 / (self.m + self.M), self.m * self.g * v1, -self.bp * v1]
        #       ]
        # Bc = [[0],[v2],[0],[self.m * self.l * v1 / (self.m + self.M)]]

        ### Store matrices as class variables
        self.Ac = Ac
        self.Bc = Bc 
        # print(Ac @ x + Bc @ u)
        return Ac @ x + Bc @ u  # matrix multiplication
